...
(function () {
  ...
  function onStep(btn) {
    ...
    applyStep(wrap.getAttribute('data-stepper'), parseInt(btn.getAttribute('data-step'), 10),
      parseInt(wrap.getAttribute('data-min'), 10), parseInt(wrap.getAttribute('data-max'), 10));
  }

  function applyStep(path, delta, min, max) {
  ...
  var hook = {
    ...
    step: function (path, delta, min, max) { return applyStep(path, delta, min, max); }
  };
